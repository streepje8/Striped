...
public class GuiShaderManager implements Serializable {

	private static final long serialVersionUID = 1L;
	private int programID;
	private int vertexShaderID;
	private int fragmentShaderID;
	public String guiVertexShader = "./Resources/DefaultAssets/defaultGuiVertex.shader";
	public String guiFragmentShader = "./Resources/DefaultAssets/defaultGuiFragment.shader";
	...
	public void loadToMemory() {
		this.vertexShaderID = loadShader(this.guiVertexShader, ShaderType.vertex);
		this.fragmentShaderID = loadShader(this.guiFragmentShader, ShaderType.fragment);
