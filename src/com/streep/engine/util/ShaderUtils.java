...
public class ShaderUtils {
	...
	public static void loadProperties(Camera c, Material mat, List<Light> lightList, GameObject GameObject, long Window) {
		int textureINT = 0;
		for(MaterialProperty prop : mat.properties) {
			switch(prop.type) {
				...
				case MatrixData:
					...
					Matrix4f transform = SMath.createTransformationMatrix(GameObject.position,GameObject.rotation, GameObject.scale);
